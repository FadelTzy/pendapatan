                ...
                <div class="border p-4 rounded">
                    <form id="tambahdata">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="kode_lembaga" value="{{ $data->kode_lembaga }}" class="form-control"
                                    id="kode_lembaga" placeholder="Kode Lembaga">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="kode_satker" value="{{ $data->kode_satker }}" class="form-control"
                                    id="kode_satker" placeholder="Kode Satker">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="kode_tempat" value="{{ $data->kode_tempat }}" class="form-control"
                                    id="kode_tempat" placeholder="Kode Tempat">
                            </div>
                        </div>
                        <div class="card-title d-flex align-items-center">
                            <div><i class="bx bxs-cog me-1 font-22 text-info"></i>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="kode_lokasi" value="{{ $data->kode_lokasi }}" class="form-control"
                                    id="kode_lokasi" placeholder="Kode Lokasi">
                            </div>
                        </div>
                        <div class="card-title d-flex align-items-center">
                            <div><i class="bx bxs-cog me-1 font-22 text-info"></i>
                            </div>
                            <h5 class="mb-0 text-info">Pejabat</h5>
                        </div>
                        <hr />
                        <div class="row mb-3">
                            <label for="Pejabat" class="col-sm-3 col-form-label">Kuasa Pengguna Anggaran
                            </label>
                            <div class="col-sm-6">
                                <input type="text" name="penerbit" value="{{ $data->penerbit }}" class="form-control"
                                    id="penerbit" placeholder="Nama Penerbit">
                            </div>
                            <div class="col-sm-3">
                                <input type="text" name="nippenerbit" value="{{ $data->nip }}" class="form-control"
                                    id="nippenerbit" placeholder="NIP Penerbit">
                            </div>
                            <br>
                        
                        </div>
                        <div class="row mb-3">
                            <label for="Pejabat" class="col-sm-3 col-form-label">Bendahara Penerimaan</label>
                            <div class="col-sm-6">
                                <input type="text" name="bendahara" value="{{ $data->bendahara }}" class="form-control"
                                    id="bendahara" placeholder="Nama bendahara">
                            </div>
                            <div class="col-sm-3">
                                <input type="text" name="nipbendahara" value="{{ $data->nipbendahara }}" class="form-control"
                                    id="nipbendahara" placeholder="NIP bendahara">
                            </div>
                            <br>
                        
                        </div>
                        {{-- <div class="row mb-3">
                            <label for="Pejabat" class="col-sm-3 col-form-label">SP2D - 1</label>
                            <div class="col-sm-6">
                                <input type="text" name="sp2d" value="{{ $data->sp2d }}" class="form-control"
                                    id="sp2d" placeholder="Nama sp2d">
                            </div>
                            <div class="col-sm-3">
                                <input type="text" name="nipsp2d" value="{{ $data->nipsp2d }}" class="form-control"
                                    id="nipsp2d" placeholder="NIP sp2d">
                            </div>
                            <br>
                        
                        </div>
                        <div class="row mb-3">
                            <label for="Pejabat" class="col-sm-3 col-form-label">SP2D - 2</label>
                            <div class="col-sm-6">
                                <input type="text" name="sp2d2" value="{{ $data->sp2d2 }}" class="form-control"
                                    id="sp2d2" placeholder="Nama sp2d2">
                            </div>
                            <div class="col-sm-3">
                                <input type="text" name="nipsp2d2" value="{{ $data->nipsp2d2 }}" class="form-control"
                                    id="nipsp2d2" placeholder="NIP sp2d2">
                            </div>
                            <br>
                        
                        </div> --}}
                        {{-- <div class="row mb-3">
                            <label for="Pejabat" class="col-sm-3 col-form-label">Kewenangan Pelaksanaan</label>

                            <div class="col-sm-9">
                                <input type="text" name="kp" value="{{ $data->kp }}" class="form-control"
                                    id="kp" placeholder="Kewenangan Pelaksanaan">
                            </div>
                        </div> --}}
                        <div class="row mb-3">
                            <label for="Pejabat" class="col-sm-3 col-form-label">KPPN</label>

                            <div class="col-sm-9">
                                <input type="text" name="kppn" value="{{ $data->kppn }}" class="form-control"
                                    id="kppn" placeholder="KPPN">
                            </div>
                        </div>
                        <div class="row">
