    ...
    <div class="page-content">
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="uploaddata" class=" form-horizontal form-bordered">
                            @csrf
                                <label for="">Khusus File Excel (2mb)</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="submitup" type="button" class="btn btn-primary">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#exampleLargeModal"
                ...
                class="btn btn-sm btn-success">Upload Data <i class="bx bx-folder-plus"></i></button>
        </div>
...
@push('js')
    ...
    <script>
        ...
        $("#submitup").on('click', function() {
            $("#uploaddata").trigger('submit');
        });
        $("#uploaddata").on('submit', function(id) {
            id.preventDefault();
            var data = $(this).serialize();
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ route('supplier.upload') }}',
