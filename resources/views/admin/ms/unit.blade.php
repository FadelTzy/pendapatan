...
@section('content')
    <div class="page-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambahdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="text" name="unit" placeholder="Input unit" class="form-control" />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editdata" class=" form-horizontal form-bordered">
                            ...
                            <div class="input-group">
                                <input type="text" id="unitu" name="unit" placeholder="Input unit" class="form-control" />
        ...
        <div style="vertical-align: bottom" class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase">Manajemen Data Unit </h6>
