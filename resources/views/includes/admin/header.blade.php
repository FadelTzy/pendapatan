        ...
        <div class="d-flex container-xxl align-items-stretch">
            ...
            <div class="d-flex align-items-center align-items-lg-stretch me-5 flex-row-fluid">
                ...
                <a href="index.html" class="d-flex align-items-center">
                    <img alt="Logo" src="{{ asset('').'sepadan.png' }}" class="h-45px h-lg-40px" />
                </a>
                <!--end::Logo-->
                <!--begin::Tabs wrapper-->
                <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                    ...
                    <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs"
                        ...
                        <ul class="nav flex-nowrap text-nowrap">
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(2) == '') active @endif" data-bs-toggle="tab"
                                    href="#kt_header_navs_tab_dash">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(2) == 'buku-pembantu' || Request::segment(2) == 'referensi' || Request::segment(2) == 'buku-kas-umum') active @endif" data-bs-toggle="tab"
                                    href="#kt_header_navs_tab_1">Data Pendapatan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(2) == 'lpj' || Request::segment(2) == 'pengesahan' || Request::segment(2) == 'rincian-pengesahan'|| Request::segment(2) == 'akun-pendapatan') active @endif" data-bs-toggle="tab"
                                    href="#kt_header_navs_tab_2">Laporan</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(2) == 'akun') active @endif" data-bs-toggle="tab"
                                    href="#data_master">Data Master</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(1) == 'pembayaran') active @endif" data-bs-toggle="tab"
                                    href="#data_pembayaran">Pembayaran</a>
                            </li>
                        </ul>
                        <!--begin::Header tabs-->
                    </div>
                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ url('admin/dashboard') }}" class="menu-link px-5">Admin</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a onclick="logsout()" href="#" class="menu-link px-5">Logout</a>
        ...
        <div class="d-lg-flex container-xxl w-100">
            ...
            <div class="d-lg-flex flex-column justify-content-lg-center w-100" id="kt_header_navs_wrapper">
                ...
                <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}"
                    ...
                    <div class="tab-pane @if (Request::segment(2) == 'dashboard') show active @endif fade"
                        id="kt_header_navs_tab_dash">
                        <!--begin::Wrapper-->
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold"
                                    href="{{ route('p.index') }}">Dashboard</a>
                    ...
                    <!--begin::Tab panel-->
                    <div class="tab-pane @if (Request::segment(2) == 'buku-pembantu' || Request::segment(2) == 'referensi' || Request::segment(2) == 'buku-kas-umum') show  active @endif fade"
                        ...
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            ...
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0"
                                ...
                                <a href="{{ route('rkakl.indexv2') }}"
                                    class="menu-item  @if (Request::segment(2) == 'data-rkakl')  @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                ...
                                <!--begin:Menu item-->
                                <a href="{{ route('p.bku') }}"
                                    class="menu-item  @if (Request::segment(2) == 'kegiatan')  @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <span class="menu-link py-3">
                                        Buku Kas Umum
                                    </span>
                                ...
                                <!--begin:Menu item-->
                                <a href="{{ route('p.bp') }}"
                                    class="menu-item  @if (Request::segment(2) == 'akun')  @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <span class="menu-link py-3">
                                        Buku Pembantu
                                    </span>
                                ...
                                <a href="{{ route('p.referensi') }}"
                                    class="menu-item  @if (Request::segment(2) == 'akun-realisasi')  @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <span class="menu-link py-3">
                                        Referensi
                                    </span>
                    ...
                    <!--end::Tab panel-->
                    <!--begin::Tab panel-->
                    <div class="tab-pane @if (Request::segment(2) == 'pengesahan' || Request::segment(2) == 'lpj') show active @endif fade"
                        id="kt_header_navs_tab_2">
                        <!--begin::Wrapper-->
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                {{-- <a class="btn btn-sm btn-light-primary fw-bold" href="{{ url('spm') }}">LPJ</a>
                                <a id="sppmenubaru" class="btn btn-sm btn-light-success fw-bold" href="#">SPP
                                    Baru</a> --}}
                                    <a class="btn btn-sm btn-light-primary fw-bold" href="{{ route('p.lpj') }}">LPJ</a>
                                    <a class="btn btn-sm btn-light-success fw-bold" href="{{route('pengesahan')}}">Pengesahan</a>
                                    <a class="btn btn-sm btn-light-success fw-bold" href="{{route('r.pengesahan')}}">Rincian Pengesahan</a>
                                    <a class="btn btn-sm btn-light-success fw-bold" href="{{route('p.ap')}}">Akun Pendapatan</a>
                    ...
                    <!--end::Tab panel-->
                    <!--begin::Tab panel-->
                    <div class="tab-pane @if (Request::segment(2) == 'akun') show active @endif fade" id="data_master">
                        <!--begin::Wrapper-->
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold " href="{{ route('akun.indexv2') }}">Akun</a>
                    ...
                    <!--end::Tab panel-->
                    <div class="tab-pane @if (Request::segment(1) == 'pembayaran') show active @endif fade" id="data_pembayaran">
                        <!--begin::Wrapper-->
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold " href="{{ route('bayar.index') }}">SPP</a>
