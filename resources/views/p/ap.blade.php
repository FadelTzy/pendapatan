            ...
            <div class="card card-flush pt-3 mb-1 mb-xl-10">
                ...
                <div class="card-header">
                    ...
                    <div class="card-title">
                        <h2 class="fw-bold">LAPORAN AKUN PENDAPATAN {{ $rkakl->tahun_anggaran }}</h2>
                    </div>
                    <!--begin::Card title-->
                    <!--begin::Card toolbar-->
                    <div class="card-toolbar d-flex justify-end">
                        ...
                        <div class="input-group ">
                            ...
                            <input type="date" value="{{ request()->query('tanggalaw') }}" class="form-control" name="tanggalaw">
                            <label for="">Last Date :</label>

                            <input value="{{ request()->query('tanggalak') }}" type="date" class="form-control" name="tanggalak">
                ...
                <div class="card-body pt-3">
                    ...
                    <div class="mb-0">
                        <!--begin::Title-->
                        <h3 class="fw-bold"> {{$first}} - {{$last}} </h3>
