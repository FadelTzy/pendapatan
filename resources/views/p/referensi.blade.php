                        ...
                        <div class="d-flex flex-wrap py-5">
                            ...
                            <div class="flex-equal me-5">
                                ...
                                <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
                                    <!--begin::Row-->
                                    <tr>
                                        <td class="text-gray-800 min-w-175px w-175px">Tahun Pendapatan {{$rkakl->tahun_anggaran}}</td>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <button data-bs-toggle="modal" @if ($rkakl->status_draft == 2)
                            
                        @endif data-bs-target="#exampleLargeModal" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Tambah Akun
                            </button>
                            <button onclick="sync({{$rkakl->id}})" type="button" class="btn btn-sm btn-warning"> <i class="fa fa-circle"></i> Copy Paste
                                    </button>
                       
                                <a href="{{url('cetak/referensi/')}}" target="_blank"
                            class="btn btn-sm btn-danger"> <i class="fa fa-print"></i> Cetak
                                </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Card toolbar-->
...
@push('addon-script')
    ...
    <script>
        ...
        function addRo(id) {
            var data = id.m_d;
            var ht = '<option selected disabled>Pilih Detail</option>';
            data.forEach(element => {
                ht += `<option value="${element.id}">${element.detail}</option>`;
            });
            $("#budadi").html(ht);
            console.log(data,'addro');
        ...
        function format(d) {
            ...
            if (d['status_cabang']  == 1) {
                ...
                datarow += `<tr class='table-success table-sm' > 
                    ...
                    <td class='pt-1 pb-1' colspan='1'>&nbsp&nbsp&nbsp&nbsp ${id['m_d']['detail']} </td>
                    <td class='pt-1 pb-1'>   <ul class='list-inline mb-0'>
                    <li class='list-inline-item'>
