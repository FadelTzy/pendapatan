...
@section('content')
    ...
    <div style="padding: 5px;border-bottom: 1px solid black;border-top: 0px" class="bordered">
            ...
            <tbody>
                ...
                @if ($untukup->jenis == 1)
                    @foreach ($newArr as $key => $item)
                        <tr>
                            <td style="text-align:right;">{{ $item['kode'] == 0 ? ' ' : $item['kode'] }} </td>
                            <td style="text-align:right;vertical-align: top;">
                                @if ($item['jumlah'] != 0)
                                    @money($item['jumlah'], 'IDR', 'true')
                                @endif
                            </td>
                            <td style="text-align:right;">{{ $item['kodepajak'] == 0 ? ' ' : $item['kodepajak'] }} </td>
                            <td style="text-align:right;vertical-align: top;">@money($item['nilaipajak'], 'IDR', 'true')</td>

                        </tr>
                        @php
                            
                            $totalpajak = $totalpajak + $item['nilaipajak'];
                    ...
                    @foreach ($pajak as $key => $item)
                        <tr>
                            ...
                            @else
                                ...
                                <td></td>
                            @endif
                            <td style="text-align:right;">{{ $item->oPajak->kode }} </td>
                            <td style="text-align:right;vertical-align: top;">@money($item->jumlah, 'IDR', 'true')</td>

                            @php
                            $totalpajak = $totalpajak + $item->jumlah;
                            @endphp
                        </tr>
                    @endforeach
                @endif
                ...
                @if ($untukup->jenis == 1)
                    <tr>
                        ...
                        <td style="text-align:right;border: 0.5px solid black;">@money($totalpajak, 'IDR', 'true')</td>
                    </tr>
                    <tr>
                        <td style="text-align:right;"></td>
                        <td style="text-align:right;"></td>
                        <td style="text-align:right;"></td>
                        <td style="text-align:right;border: 0.5px solid black;">@money($nilai - $totalpajak, 'IDR', 'true')</td>
                    </tr>
                @else
                    <tr>
                        <td style="text-align:right;border: 0.5px solid black;">Jumlah Pengeluaran</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"></td>
                        <td style="text-align:right;"></td>
                        <td style="text-align:right;border: 0.5px solid black;">@money($dataup['nilai'] - $totalpajak, 'IDR', 'true')</td>
                    </tr>
                @endif
