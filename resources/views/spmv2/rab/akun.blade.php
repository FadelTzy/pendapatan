...
@section('content')
                    ...
                    <form id="formrabakun" class=" form-horizontal form-bordered">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" name="kppn" value="{{$set->kppn}}" readonly class="form-control" id="kppn">
                                </div><!-- input-group -->
                                <br>
    ...
    <div class="modal fade" id="modalrou" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Detail RAB</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formrabdetailu" class=" form-horizontal form-bordered">
                        ...
                        <input type="hidden" id="hiddentotalu" name="hiddentotal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="form-label">Keterangan</label>
                                <div class="input-group">
                                    <input type="text" name="keterangan"  id="keteranganu" class="form-control">
                                </div><!-- input-group -->
                                <br>
                            </div>
                            <div class="col-md-4">
                                ...
                                <label class="form-label">Kuantitas</label>
                                <div class="input-group">
                                    <input type="number" value="1" onkeyup="cekhargaku(this)" name="kuantitas" id="kuantitasu" class="form-control">
                                </div><!-- input-group -->
                                <br>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Satuan</label>
                                <div class="input-group">
                                    <input type="text" name="satuan" id="satuanu" placeholder="Input Satuan" class="form-control">
                                </div><!-- input-group -->
                                <br>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Harga / Satuan</label>
                                <div class="input-group">
                                    <input type="number" onkeyup="cekhargau(this)" id="hargasatuanu" name="harga" class="form-control">
                                </div><!-- input-group -->
                                <br>
                            </div>
                            <div class="col-md-12">
                                ...
                                <label class="form-label">Total Harga</label>
                                <div class="input-group">
                                    <input type="text" name="total"  id="totalhargau" class="form-control">
                                </div><!-- input-group -->
                                <br>
                            </div>
                            <div class="col-md-12">
...
@push('addon-script')
    ...
    <script>
        ...
        function cekhargaku(e) {
            var c = e.value;
            let kuan = $("#hargasatuanu").val();
            let tot = c * kuan;
            tot = (Math.floor(tot / 1000) * 1000 )
        ...
        $("#btnrabdetailu").on('click', function() {
            $("#formrabdetailu").trigger('submit');
        });
        ...
        $("#formrabdetailu").on('submit', function(id) {
            id.preventDefault();
            var data = $(this).serialize();
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ route('rabdetail.update') }}',
                data: new FormData(this),
                type: "POST",
                contentType: false,
                processData: false,
        ...
        function format(d) {
            ...
            if (d['status_cabang']  == 1) {
                ...
                var dstotal = id['biaya'];
                var dsket = id['keterangan'];
                var dsunit = id['unit'];
                var dsid = id['id'];
                var dsvol = id['volume'];
                var dshs = id['hargasatuan'];
                var dssatuan = id['satuan'];
                ...
                datarow += `<tr class='table-success table-sm' > 
                    ...
                    <li class='list-inline-item'>
                        ...
                        <button type='button' data-toggle='modal' onclick='updrab("${dstotal}","${dsket}","${dsunit}","${dsid}","${dsvol}","${dshs}","${dssatuan}")'   class='btn btn-sm btn-success btn-xs mb-1'><i class='fa fa-edit'> </i>  </button>
        ...
        function updrab(total,ket,unit,id,vol,hs,satuan) {
            $("#modalrou").modal('show');
            $("#eidu").val(id)
            $("#keteranganu").val(ket);
            $("#kuantitasu").val(vol);
            $("#satuanu").val(satuan);
            $("#hargasatuanu").val(hs);
            $("#totalhargau").val(idr(total));
            $("#hiddentotalu").val(total)
            console.log(hs);
            $("#unitu").val(unit)
        }
